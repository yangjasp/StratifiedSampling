...
# Create plot
p1 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                            "SRS", "Optimal Poisson prob Wang M-A calculation")
...
# Create plot
p2 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                            "SRS", "Optimal Poisson prob Wang M-A calculation")
)), aes(x = n, y = MSE_B, color = color, shape = color, linetype = type)) +
  geom_point() +
  geom_line(aes(group = method)) +
...
# Create plot
p3 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                      "SRS", "Optimal Poisson prob Wang M-A calculation")
...
# Create plot
p4 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                             "SRS", "Optimal Poisson prob M-A calculation")
...
# Create plot
pS2 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                             "SRS", "Optimal Poisson prob Wang M-A calculation")
)), aes(x = n, y = MSE_B, color = color, shape = color, linetype = type)) +
  geom_point() +
  geom_line(aes(group = method)) +
...
# Create plot
pS3 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                             "SRS", "Optimal Poisson prob Wang M-A calculation")
)), aes(x = n, y = MSE_B, color = color, shape = color, linetype = type)) +
  geom_point() +
  geom_line(aes(group = method)) +
...
# Create plot
pS4 <- ggplot(dplyr::filter(results_summary, !(method %in% c("Surrogate Optimal Poisson prob my calc",
                                                             "SRS", "Optimal Poisson prob Wang M-A calculation")
)), aes(x = n, y = MSE_B, color = color, shape = color, linetype = type)) +
  geom_point() +
  geom_line(aes(group = method)) +
